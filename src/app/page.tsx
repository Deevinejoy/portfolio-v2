...
export default function Home() {
  ...
  const projects = [
    ...
    {
        name: 'Craft',
        des: 'e commerce-site for furniture',
            ...
            <div className="relative w-full flex justify-center">
              ...
              <div className="text-center space-y-6 max-w-4xl mx-auto relative z-10 p-8 rounded-2xl">
                ...
                >
                  ...
                  />
                  <SocialIcon 
                    href="https://linkedin.com/in/divine-joy-akinola-32a4b4371"
                    icon={
                      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
          ...
          <section className="py-20 px-4  from-pink-50/50 to-purple-50/50">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {['React', 'Next.js', 'React Native', 'MongoDB','TypeScript', 'Expressjs', 'Tailwind CSS', 'Node.js', 'UI/UX Design', 'Animation', 'Responsive Design'].map((skill, index) => (
